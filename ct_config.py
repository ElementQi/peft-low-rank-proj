...
class CTConfig(PeftConfig):
    ...
    Args:
        ...
        use_rslora (`bool`):
            ...
            sets the adapter scaling factor to `delta_alpha/math.sqrt(r)`, since it was proven to work better.
            Otherwise, it will use the original default value of `delta_alpha/r`.
    ...
    use_rslora: bool = field(
        ...
        metadata={
            "help": (
                ...
                " which sets the adapter scaling factor to `delta_alpha/math.sqrt(r)`, since it"
                " was proven to work better. Otherwise, it will use the original default"
                " value of `delta_alpha/r`."
            )
        },
    )
    ...
    alpha_pattern: Optional[dict] = field(
        ...
        metadata={
            "help": (
                "The mapping from layer names or regexp expression to alphas which are different from the default alpha specified by `delta_alpha`. "
